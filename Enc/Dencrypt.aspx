<%@ Page Title="Dencrypt" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dencrypt.aspx.cs" Inherits="Enc.Dencrypt" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <style>
    ...
    <div>
        <asp:Button runat="server" ID="EncryptBtn" type="button" text="Расшифровать" class="btn btn-success" name="encrypt" onclick ="VisinerDen"></asp:Button>
    </div>
    <div>
        <h3>
            После дешифровки
